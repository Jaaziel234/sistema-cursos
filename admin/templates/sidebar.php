   ...
   <!-- Sidebar menu-->
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="vistaCarrera.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Carreras</span></a></li>
        <li><a class="app-menu__item" href="vistaTema.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Temas de cursos</span></a></li>
        <li><a class="app-menu__item" href="vistaAgregarContenido.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Contenido de curso</span></a></li>
        <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Pago</span></a></li>
        <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Planes</span></a></li>
        <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Administrador</span></a></li>
      </ul>
    </aside>
