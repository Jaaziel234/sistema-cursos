          ...
          <div class="col-lg-6">
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input name="nombrePlan" class="form-control" id="nombrePlan" type="text" placeholder="nombrePlan" value="<?php echo $nombrePlan ?>">
              </div>
              <div class="form-group">
                <label for="Descripcion">Descripcion</label>
                <input name="descripcion" class="form-control" id="Descripcion" type="text" placeholder="Descripcion" value="<?php echo $descripcion ?>">
              </div>
              <div class="form-group">
