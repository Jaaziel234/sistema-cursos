...
//Consulta SQL
$sql = "SELECT curso.Id,Nombre,curso.Descripcion,Fecha,DuracionCurso,Precio,Imagen,docente.Nombres,docente.Apellidos,docente.Descripcion,docente.Foto FROM curso INNER JOIN docente ON curso.Id_Docente = docente.Id";
